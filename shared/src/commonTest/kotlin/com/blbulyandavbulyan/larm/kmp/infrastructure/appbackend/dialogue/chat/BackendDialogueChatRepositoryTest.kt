...
import com.blbulyandavbulyan.larm.kmp.infrastructure.appbackend.client.data.dialogue.chat.DialogueChatResponseMother
import com.blbulyandavbulyan.larm.kmp.infrastructure.appbackend.client.data.dialogue.chat.SaveDialogueRequestMother
...
class BackendDialogueChatRepositoryTest {
    @Test
    fun `generateDialogue delegates to ApiClient correctly`() = runTest {
        ...
        val repository = BackendDialogueChatRepository(apiClient)
